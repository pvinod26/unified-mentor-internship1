        ...
        data: [
            {
                ...
                history: "Known as 'Kaliyuga Vaikuntam,' this is the residence of Lord Venkateswara, who appeared here to save mankind from the trials of Kali Yuga. Legend says the Lord resides here until his debt to Kubera—borrowed for his wedding with Padmavati—is fully paid back by the offerings of devotees.",
    ...
    architecture: "Classic Dravidian style featuring the 'Ananda Nilayam'—a three-tier gold-plated Vimana over the Garbhagriha. The temple complex is built on Venkatadri, one of the seven peaks of Seshachalam, designed to resemble the seven hoods of Adisesha.",
    wait: 12, weather: "☀️ 26°C", 
            ...
            document.getElementById('templeGrid').innerHTML = list.map(t => {
                ...
                <div class="temple-card" onclick="app.open(${t.id})">
                    ...
                    <div class="card-content">
                        ...
                        <p style="font-size:0.85rem; color:var(--gray)">📍 ${dist} km away</p>
                    </div>
                </div>`;
            }).join('');
        },
                ...
                <div class="modal-grid">
                    <div class="modal-left">
                        ...
                        <div id="ritual-view" style="display:none">
                            <h4 style="font-family:Cinzel; color:var(--gold); margin-bottom:20px">🔔 Ritual Timings</h4>
                    ...
                    <div class="modal-right">
                        <h5 style="color:var(--gold); font-size:0.8rem; text-transform:uppercase">🏨 Stay</h5><p>${t.stay}</p><br>
                        <h5 style="color:var(--gold); font-size:0.8rem; text-transform:uppercase">🍴 Dining</h5><p>${t.eat}</p><br>
                        <div style="background:var(--royal); color:white; padding:25px; border-radius:15px; border-top:4px solid var(--saffron)">
                            ...
                            <p style="font-size:0.8rem">👗 Traditional wear mandatory.</p>
                            <p style="font-size:0.8rem; margin:8px 0">🚫 No electronics inside.</p>
                            <p style="font-size:0.8rem; color:var(--saffron)">🆘 Helpline: 1800-425-3333</p>
                        </div>
                    </div>
                </div>
            `;
